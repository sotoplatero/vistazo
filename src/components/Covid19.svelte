...
<div>
	{#if data}
		...
		<div class="bg-red-700 shadow-lg rounded-lg mb-5">
			...
			<table class="table table-red table-auto w-full">
				...
				<tbody>
					<tr>
						...
						<td class="text-right text-lg"><b>{data.dia.diagnosticados.length}</b></td>
						<td class="text-right text-lg"><b>{data.total.diagnosticados_numero}</b></td>
					</tr>
					<tr>
						<td>Recuperados</td>
						<td class="text-right text-lg"><b>{data.dia.recuperados_numero}</b></td>
						<td class="text-right text-lg"><b>{data.total.recuperados_numero}</b></td>
					</tr>
					<tr>
						<td>Fallecidos</td>
						<td class="text-right text-lg"><b>{data.dia.muertes_numero}</b></td>
						<td class="text-right"><b>{data.total.muertes_numero}</b></td>
					</tr>
					<tr>
						<td>Graves</td>
						<td class="text-right text-lg"><b>{data.dia.graves_numero}</b></td>
						<td></td>
					</tr>
